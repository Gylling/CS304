...
public class LoginWindow extends JFrame implements ActionListener {
	...
	public void showFrame(LoginWindowDelegate delegate) {
        ...
        //Hardcoded user login and password
        delegate.login("ora_egylling", "a36895605");

////// Out commented the rest because there is no need for it now. We might want to use it for later. //////////
//		loginAttempts = 0;
//
